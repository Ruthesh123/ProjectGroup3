...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || 'demo-internlink.firebaseapp.com',
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || 'demo-internlink',
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || 'demo-internlink.appspot.com',
